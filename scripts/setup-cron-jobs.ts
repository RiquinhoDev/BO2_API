...
const CONFIG = {
  ...
  // ✅ NOVO: startsIn independentes (CursEduca primeiro)
  testInterval: {
    curseducaStartsIn: 2,      // 📚 CursEduca começa daqui a 2 min
    hotmartAfterCurseduca: 10  // 🔥 Hotmart começa 10 min depois do CursEduca
  }
}
...
if (CONFIG.enableTestJobs) {
  ...
  console.log('🧪 Simula execução de produção (CursEduca → Hotmart)')
  console.log('🧪 ════════════════════════════════════════════════════\n')

  // ─────────────────────────────────────────────────────────
  // JOB 1: CURSEDUCA (daqui a X minutos)
  // ─────────────────────────────────────────────────────────

  const curseducaTiming = getTestCronExpression(CONFIG.testInterval.curseducaStartsIn)

  console.log('📚 JOB 1: CURSEDUCA')
  console.log(`   Hora atual: ${new Date().toLocaleTimeString('pt-PT')}`)
  console.log(`   Inicia em: ${CONFIG.testInterval.curseducaStartsIn} minutos`)
  ...
  const curseducaJobData = {
    ...
    description: `Teste de sync CursEduca (primeiro) - ${curseducaTiming.targetTime.toLocaleTimeString('pt-PT')}`,
    syncType: "curseduca",
  ...
  console.log('')
       ...
       // ─────────────────────────────────────────────────────────
  // JOB 2: HOTMART (10 min depois do CursEduca)
  // ─────────────────────────────────────────────────────────

  const hotmartStartsIn =
    CONFIG.testInterval.curseducaStartsIn + CONFIG.testInterval.hotmartAfterCurseduca

  const hotmartTiming = getTestCronExpression(hotmartStartsIn)

  console.log('🔥 JOB 2: HOTMART')
  console.log(`   Inicia em: ${hotmartStartsIn} minutos (${CONFIG.testInterval.hotmartAfterCurseduca} min após CursEduca)`)
  ...
  const hotmartJobData = {
    ...
    description: `Teste de sync Hotmart (após CursEduca) - ${hotmartTiming.targetTime.toLocaleTimeString('pt-PT')}`,
    syncType: "hotmart",
