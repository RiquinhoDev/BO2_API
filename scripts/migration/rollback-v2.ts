...
async function rollback() {
  ...
  try {
    ...
    userProductsFound = await UserProduct.countDocuments()
    productsFound = await Product.countDocuments()
    const classesWithProduct = await Class.countDocuments({ productId: { $exists: true } })
