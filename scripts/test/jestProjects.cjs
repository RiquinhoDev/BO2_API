...
const INTEGRATION_TEST_FILES = Object.freeze([
  ...
  'tests/controllers/guruInactivationRead.characterization.test.ts',
  'tests/controllers/guruInactivationMutation.characterization.test.ts',
  'tests/controllers/guruInactivationExternal.characterization.test.ts',
  'tests/controllers/guruWebhookList.controller.test.ts',
  'tests/controllers/hotmartClassSync.characterization.test.ts',
  ...
  'tests/controllers/userInfiniteListing.characterization.test.ts',
  'tests/controllers/userListingStats.characterization.test.ts',
  'tests/controllers/userPlatformStats.characterization.test.ts',
  'tests/controllers/userProductStats.characterization.test.ts',
  ...
  'tests/services/clareza/clarezaRefreshExecution.receipt.test.ts',
  ...
  'tests/services/guru/guruExternalInactivation.receipt.test.ts',
  'tests/services/renewal/discordMessageExecution.receipt.test.ts',
  'tests/services/renewal/discordMessageExecution.scheduled.receipt.test.ts',
