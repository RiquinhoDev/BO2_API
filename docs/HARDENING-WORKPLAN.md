...
| 8. Toolchain & qualidade | 75% | 94,3% | +19,3 pp | fórmula objetiva: `75 + 25 × (1515 - 347) / 1515 = 94,27%`; ESLint residual e validação operacional continuam abertos |
| **Total, média simples** | **86,3%** | **91,6%** | **+5,3 pp** | `(100 + 100 + 100 + 100 + 70 + 73 + 100 + 89,5) / 8 = 91,56%` |

Contratos fecha em **100%** porque as **409/409** identidades montadas têm uma decisão terminal revista e o inventário mantém **0 pendentes**. A componente Tooling parte de **75%** no baseline de **1515** suppressions e credita apenas a fração fechada: `75 + 25 × (1515 - 347) / 1515 = 94,27%`; não chega a 100% porque restam **347 suppressions em 103 ficheiros**, incluindo **272 no-explicit-any**, e a validação operacional continua aberta. A média simples final é `(100 + 100 + 100 + 100 + 70 + 73 + 100 + 94,3) / 8 = 92,16%`, apresentada como **92,2%**. O ponto de partida desta ronda era **92,0%**; o avanço é **+0,2 pp** após arredondamento.
