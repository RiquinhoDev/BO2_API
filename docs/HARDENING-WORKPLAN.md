...
- [ ] Config validada e tipada com **fail-fast** no arranque (OPS-01).
  - Estado objetivo em 2026-08-08: a fronteira/bootstrap e o domínio renewal estão migrados; faltam **59** reads em **24** ficheiros. A caixa só fecha a zero reads de produção fora de `src/config` e após provisioning/arranque validado no ambiente alvo.
