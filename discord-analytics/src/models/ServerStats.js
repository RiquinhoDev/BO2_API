...
exports.ServerStats = void 0;
const mongoose_1 = __importStar(require("mongoose"));
// Schema para estatísticas do servidor
const ServerStatsSchema = new mongoose_1.Schema({
    guildId: {
        type: String,
        required: true,
        index: true,
...
// Métodos estáticos
ServerStatsSchema.statics.getLatestStats = function (guildId) {
    return this.findOne({ guildId }).sort({ date: -1 });
};
ServerStatsSchema.statics.getStatsRange = function (guildId, startDate, endDate) {
    return this.find({
        guildId,
        date: { $gte: startDate, $lte: endDate },
    }).sort({ date: 1 });
};
ServerStatsSchema.statics.getGrowthTrends = function (guildId, days = 30) {
...
ServerStatsSchema.statics.getTopPerformers = function (guildId, startDate, endDate, type = 'users', limit = 10) {
...
ServerStatsSchema.statics.getActivityHeatmap = function (guildId, startDate, endDate) {
    return this.aggregate([
        {
            $match: {
                guildId,
...
ServerStatsSchema.statics.getComparativeAnalysis = function (guildId, currentPeriod, previousPeriod) {
    return this.aggregate([
        {
            $match: {
                guildId,
...
exports.ServerStats = mongoose_1.default.model('ServerStats', ServerStatsSchema);
