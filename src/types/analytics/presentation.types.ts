...
export interface ChartConfig {
  type: 'line' | 'bar' | 'area' | 'pie' | 'heatmap'; data: any[]; xKey: string; yKey: string | string[]
  colors?: string[]; legend?: boolean; tooltip?: boolean; grid?: boolean; responsive?: boolean
}
export interface BaseChartProps { data: any[]; loading?: boolean; error?: string; height?: number; width?: number | string; className?: string }
