...
const CURSEDUCA_API_KEY = process.env.CURSEDUCA_API_KEY || '***REMOVED-CURSEDUCA-KEY***'
const CURSEDUCA_ACCESS_TOKEN = process.env.CURSEDUCA_ACCESS_TOKEN || '***REMOVED-JWT***'
