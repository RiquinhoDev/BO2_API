...
export const getEngagementStats = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    // ✅ Contar users do Curseduca (QUERY IDÊNTICA ao getDashboardStats)
...
// Contar quantos users existem em cada plataforma
// ================================================================
...
//     // ===== PARTE 1: AGREGAÇÃO PARA ENGAGEMENT (mantém igual) =====
//     const stats = await User.aggregate([
//       {
//         $match: {
//           $or: [
...
//     // Calcular média de engagement
//     const averageScore = result.totalUsers > 0 
//       ? Math.round(result.totalScore / result.totalUsers) 
//       : 0

//     // ===== PARTE 2: CONTADORES POR PLATAFORMA (O QUE IMPORTA!) =====
//     const baseQuery = { isDeleted: { $ne: true } }
    
//     // 🛒 CONTADOR HOTMART
//     // Conta quantos users têm hotmartUserId preenchido
//     const hotmartUsers = await User.countDocuments({
//       ...baseQuery,
//       $or: [
//         { 'hotmart.hotmartUserId': { $exists: true, $nin: [null, ''] } },
...
//     // 🎓 CONTADOR CURSEDUCA  
//     // Conta quantos users têm curseducaUserId preenchido
//     const curseducaUsers = await User.countDocuments({
//       ...baseQuery,
//       $or: [
...
//     // 💬 CONTADOR DISCORD
//     // Conta quantos users têm pelo menos 1 discordId
//     const discordUsers = await User.countDocuments({
//       ...baseQuery,
//       $or: [
//         { 'discord.discordIds.0': { $exists: true } },
...
//     // ===== LOG PARA DEBUG =====
//     console.log('📊 Contadores por Plataforma:', {
//       total: result.totalUsers,
//       hotmart: hotmartUsers,    // Deve ser ~4162
//       curseduca: curseducaUsers, // Deve ser 4
//       discord: discordUsers      // Deve ser o valor real
//     })

//     // ===== PARTE 3: MONTAR RESPONSE =====
//     const responseData = {
//       totalUsers: result.totalUsers,
//       activeUsers: result.activeUsers,
//       averageScore,
...
//       // Usar os contadores que acabamos de calcular
//       platformStats: {
//         hotmartUsers,      // ✅ Contador real do Hotmart
//         discordUsers,      // ✅ Contador real do Discord
//         curseducaUsers,    // ✅ Contador real do Curseduca
//         activeUsers: result.activeUsers
//       }
//     }
...
//       total: responseData.totalUsers,
//       platforms: responseData.platformStats
//     })
